...
const Contact = () => {
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <p className='text-gray-500 max-w-80 text-center mb-12 mx-auto'>Ready to Move? Lets Build Your Future Together  </p>
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <div className='my-6 text-left'>
            Message
            <textarea name='Message' placeholder='Message' className='w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 resize-none' required></textarea>
        </div>
